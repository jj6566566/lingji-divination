      ...
      <form onSubmit={handleSubmit} className="flex items-end gap-3 max-w-2xl mx-auto">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full resize-none rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-md px-4 py-2.5 text-[15px] leading-6 min-h-11 text-white placeholder:text-white/25 focus:border-[#c9a96e]/30 focus:outline-none focus:ring-1 focus:ring-[#c9a96e]/15 disabled:opacity-40 transition-colors"
          />
        </div>
